package basic.learnlambda;

import java.util.ArrayList;
import java.util.List;
import java.util.stream.Collectors;

import static basic.learnlambda.IterateListLambdaAppMain.addElementsToList;
...
public class UseStreamAppMain {
    public static void main(String[] args) {
        ...
        myList.forEach(System.out::println); //全部都还在,不受上面filter过滤影响
