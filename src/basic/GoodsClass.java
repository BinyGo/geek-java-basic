...
public class GoodsClass {
    ...
    // TODO 每个成员变量的定义以;结束
    //public String name; TODO public:全局可见 缺省:当前包内可见 private当前类内可见
    //protected String name; TODO protected: 当前包内可见,对子类可见
    //private String name; TODO private: 仅当前包内可见
